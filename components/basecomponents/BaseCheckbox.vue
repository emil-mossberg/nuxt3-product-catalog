<template>
  <div class="baseCheckbox">
    <input
      ...
      @click="emit('click')"
    />
    <label class="baseCheckbox__label">{{ props.label }}</label>
  </div>
</template>
...
<style lang="less">
@baseCheckbox__borderColor: @color__border_dark;
@baseCheckbox__backgroundColor: @background__secondary;
@baseCheckbox__color--active: @background__tertiary;
...
.baseCheckbox {
  ...
  &__checkbox {
    ...
    &:after {
      ...
      height: 24px;
      width: 24px;
      background-color: @baseCheckbox__backgroundColor;
      border: 2px solid @baseCheckbox__borderColor;
      content: "";
    }
    ...
    &.selected {
      ...
      &:after {
        background: @baseCheckbox__color--active
          ...
          no-repeat center;
        background-size: 80%;
        border-color: @baseCheckbox__color--active;
      }

      + label {
        color: @baseCheckbox__color--active;
      }
    }
  }
}
